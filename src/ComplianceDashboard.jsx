...
import { AlertTriangle, CheckCircle, XCircle, FileText, Download, Bell, Shield, CreditCard, Users, Activity, Menu, X, LogOut, User } from 'lucide-react';
...
---
This report was generated by the TrustCare Healthcare Compliance Monitoring Dashboard
...
const facilityData = {
  name: "TranqBleu Hospital",
  type: "Private Healthcare Facility",
...
export default function ComplianceDashboard() {
  ...
  const handleCalculateScores = () => {
    ...
    const getComplianceStatus = (score) => {
      if (score >= 80) return { status: 'Compliant', color: '#10b981', icon: 'success' };
      if (score >= 60) return { status: 'Needs Improvement', color: '#f59e0b', icon: 'warning' };
      return { status: 'Non-Compliant', color: '#ef4444', icon: 'error' };
    };
    
    const pciStatus = getComplianceStatus(newPciScore);
    const ndprStatus = getComplianceStatus(newNdprScore);
    const overallStatus = getComplianceStatus(newOverallScore);
    
    // Show loading animation first
    Swal.fire({
      title: 'Calculating Compliance Scores',
      html: 'Analyzing your assessment responses...',
      timer: 1500,
      ...
      Swal.fire({
        ...
        html: `
          <div style="text-align: left; font-size: 14px;">
            <div style="margin-bottom: 20px; padding: 15px; background: #f3f4f6; border-radius: 8px;">
              <h3 style="margin: 0 0 10px 0; color: #1f2937; font-size: 16px;">Overall Compliance Score</h3>
              <div style="display: flex; align-items: center; justify-content: space-between;">
                <span style="font-size: 36px; font-weight: bold; color: ${overallStatus.color};">${newOverallScore}%</span>
                <span style="color: ${overallStatus.color}; font-weight: 600;">${overallStatus.status}</span>
              </div>
            </div>
            
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
              <div style="padding: 12px; background: #fef2f2; border-left: 4px solid ${pciStatus.color}; border-radius: 4px;">
                <div style="font-weight: 600; color: #1f2937; margin-bottom: 5px;">PCI DSS</div>
                <div style="font-size: 24px; font-weight: bold; color: ${pciStatus.color};">${newPciScore}%</div>
                <div style="font-size: 12px; color: #6b7280;">${pciStatus.status}</div>
              </div>
              
              <div style="padding: 12px; background: #eff6ff; border-left: 4px solid ${ndprStatus.color}; border-radius: 4px;">
                <div style="font-weight: 600; color: #1f2937; margin-bottom: 5px;">NDPR</div>
                <div style="font-size: 24px; font-weight: bold; color: ${ndprStatus.color};">${newNdprScore}%</div>
                <div style="font-size: 12px; color: #6b7280;">${ndprStatus.status}</div>
              </div>
            </div>
            
            ${newOverallScore < 80 ? `
              <div style="margin-top: 20px; padding: 12px; background: #fef3c7; border-radius: 6px;">
                <div style="font-weight: 600; color: #92400e; margin-bottom: 8px;">⚠️ Action Required</div>
                <ul style="margin: 0; padding-left: 20px; color: #78350f; font-size: 13px;">
                  ${newPciScore < 80 ? '<li>Improve payment card data security measures</li>' : ''}
                  ${newNdprScore < 80 ? '<li>Enhance data protection compliance</li>' : ''}
                  <li>Schedule compliance review with your officer</li>
                </ul>
              </div>
            ` : `
              <div style="margin-top: 20px; padding: 12px; background: #d1fae5; border-radius: 6px;">
                <div style="font-weight: 600; color: #065f46; margin-bottom: 8px;">✅ Excellent Compliance!</div>
                <p style="margin: 0; color: #047857; font-size: 13px;">
                  Your facility meets regulatory requirements. Continue regular monitoring to maintain compliance.
                </p>
              </div>
            `}
          </div>
        ...
        if (result.isConfirmed) {
          // Update scores and switch to overview tab
          setCalculatedScores({
            pci: newPciScore,
            ndpr: newNdprScore,
          ...
          // Just update the scores without changing tabs
          setCalculatedScores({
            pci: newPciScore,
            ndpr: newNdprScore,
            overall: newOverallScore
      ...
      <header className="bg-white shadow-sm border-b min-w-full">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-5">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">TrustCare Healthcare Compliance Monitor</h1>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-3 py-1.5 bg-red-50 hover:bg-red-100 text-red-700 rounded-md transition-colors"
                title="Sign Out"
              >
